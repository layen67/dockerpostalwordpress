...
read -p "Please enter Msql password: Fia10Kha6172 " domainpasspw
...
echo 'GRANT ALL ON `postal`.* TO `postal`@`127.0.0.1` IDENTIFIED BY "Fia10Kha6172";' | mysql -u root;
echo 'GRANT ALL PRIVILEGES ON `postal-%` . * to `postal`@`127.0.0.1`  IDENTIFIED BY "Fia10Kha6172";' | mysql -u root;
